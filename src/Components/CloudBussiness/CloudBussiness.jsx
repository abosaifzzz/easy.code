        ...
        <>
            <div dir="rtl" className="programs mt-36">
                ...
                <div className="drayeb bg-blue-200  bg-opacity-20 p-4 flex">
                    <div className="drayeb-data lg:w-1/2 md:w-2/3 w-full md:p-11 p-8">
                        ...
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            ...
                            اعدادات الضرايب للعملاء و المورديين و تحديد طبيعة كل منهما سواء
                            داخلي او مصدر مستورد او دول مجلس تعاون خليجي لان النظام يحسب كل
                            فئة بطريقة مختلفة حسب النظام السعودي
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            تحديد نسبة الضريبة لكل صنف و كذلك الاصناف المعفاة
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            الأقرار الضريبي و اقرار الفحص الخاص للمبيعات و المشتريات
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            الأقرار الضريبي علي مستوي الفرع او كامل الشركة و كذلك الفحص
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            الفاتورة الالكترونية بشقيها
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            الربط مع هيئة الزكاة بالمملكة العربية السعودية
                        </p>
                        <p className="cairo text-blue-950 m-0 mt-4 lg:text-lg text-base font-bold ">
                            <span>
                                <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                            </span>{" "}
                            عمل اي نوع من انواع الضرائب
                        </p>
                    </div>
                ...
                <div className="public relative">
                    ...
                    <div className="public-data  ">
                        <p className="messiri px-9 md:font-[1000] font-medium text-gray-600 md:text-lg text-base ">
                            ...
                            التأمين. كما يتيح إدارة فريق المبيعات من خلال متابعة العملاء
                            وتقييم الأداء لضمان صرف العمولات. بالإضافة إلى ذلك، تقدم ايزي كود
                        ...
                        <div className="first px-9 w-full md:flex">
                            ...
                            <div className="data md:w-1/2 flex flex-col justify-center">
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    ...
                                    البرنامج عبارة عن Web/Desktop Application يعمل علي نظام
                                    Windows بجميع اصداراته و يعمل كشبكة داخلية او اون لاين Cloud &
                                    Client Server
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                    ...
                                    يعمل بنظام قواعد البيانات SQL Server الذي يتيح الامان التام
                                    للبيانات و سرعة الوصول اليها
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                        <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                    </span>{" "}
                                    نظام صلاحيات دقيق و قوي للتحكم في الخيارات المتاحة لكل مستخدم
                                    بالنسبة لكل فرع في الفروع علي حدي او علي الشركة بأكملها
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                        <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                    </span>
                                    صلاحيات المستخدم في تغير السعر و اعلي نسبة خصم للمستخدمين
                                </p>
                            </div>
                        </div>
                        <div className="second px-9 bg-blue-200 bg-opacity-20    w-full md:flex">
                            ...
                            <div className="data md:w-1/2 flex flex-col justify-center">
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    ...
                                    جميع الـ Modules مترابطة تلقائيا و يمكنك التعامل مع كل Module
                                    علي حدي
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                    ...
                                    امكانية العمل في حالة انقطاع خدمة الانترنت و كذلك نقل البيانات
                                    في حالة رجوع الخدمة
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                    ...
                                    ارسال ايميلات و كذلك ارشفة كامل المستندات
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                        <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                    </span>{" "}
                                    الاضافات و الخصومات يمكن استخدامها في شتي انواع النظام
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                        <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                    </span>{" "}
                                    صلاحيات المستخدم لفترة محددة او مستديمة
                                </p>
                            </div>
                        ...
                        <div className="third my-7 px-9 w-full md:flex">
                            ...
                            <div className="data md:w-1/2 flex flex-col justify-center ">
                                ...
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    ...
                                    يمكنك عمل Export لجميع الملفات الي Excel PDF
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                        <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                    </span>{" "}
                                    ادارة محترفة و دقيقة للفروع بحيث يمكنك متابعة العمليات التي
                                    تتم علي الفروع المختلفة من اي مكان بالعالم
                                </p>
                                ...
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    ...
                                    عمل فواتير مخزنية و فواتير خدمية و فواتير التصريف (الأمانات -
                                    الأرساليات)
                                </p>
                                <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                    <span>
                                    ...
                                    امكانية البيع شامل الضريبة او احتساب الضريبة بعد سعر البيع
                                    ايهما شئت
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                إنشاء قيد واحد للحركة المالية يشمل: (قيود المبيعات، قيود
                                المشتريات، قيود الحركة المالية، ترحيل القيود اليومية، إلغاء
                    ...
                    <div className="fourth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                تقارير الحركة المالية تشمل: (كشوف الحسابات، أرصدة الحسابات،
                                تقارير سندات القبض والصرف، وتقارير الحركة المالية).
                            </p>
                ...
                <div className="clients relative overflow-hidden">
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                ختيار العميل: إمكانية تحديد ما إذا كان العميل محليًا أو دوليًا،
                                مع احتساب الضرائب المناسبة بناءً على هذا الاختيار.
                            </p>
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                <span>
                                    <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                ربط العميل بقائمة أسعار محددة: إمكانية ربط العميل بقائمة أسعار
                                معينة من القوائم المتاحة في النظام.
                            </p>
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                تعريف العميل كمورد و عميل في نفس الوقت
                            </p>
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        <div className="img md:w-1/2 flex justify-center ">
                            <img className="w-4/5" src={reportss} alt="" />
                        </div>
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                مبيعات العملاء من الأصناف (تجميعي وتفصيلي).
                            </p>
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                <span>
                                    <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                </span>
                                تقرير تسديدات الفواتير.
                            </p>
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                <span>
                                    <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                </span>
                                أعمار الديون لفواتير المبيعات.
                            </p>
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                <span>
                                    <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                                </span>
                                كشف حساب العميل حسب العملة. .
                            </p>
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                <span>
                                    <i className="text-blue-600 me-2  fa-solid fa-circle-notch"></i>{" "}
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                فواتير التصريف (الأمانات – الإرساليات): إمكانية إصدار فواتير
                                للتصريف أو الأمانات التي ترتبط بإرساليات أو شحنات يتم تسليمها
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo  text-blue-950 m-0 mt-4 md:text-lg text-base font-[650] ">
                                ...
                                سياسة السحب على المكشوف أو منعها: تتيح هذه السياسة التحكم في
                                عملية السحب على المكشوف من المخزون، مع إمكانية تمكينها أو منعها
                                حسب سياسة الشركة.
                            </p>
                ...
                <div className="sales-representative relative overflow-hidden">
                    <div className="shapes absolute md:-right-16 -right-10 z-[-1] w-1/4 top-1/2">
                        <img src={shapes} alt="" />
                    </div>
                    <div className="shapes absolute md:-left-16 left-0 z-[-1] w-1/4 top-3/4">
                    ...
                    <div className="sales-hero w-full lg:flex bg-blue-200 bg-opacity-20">
                        <div className="hero-img flex justify-center lg:w-1/2">
                            <img className="lg:w-4/5" src={representative} alt="" />
                        </div>
                        ...
                        <div className="hero-data flex flex-col justify-center lg:w-1/2">
                            ...
                            <p className="text-xl font-medium pe-14 kufi">
                                {" "}
                                قسم "مناديب المبيعات" يتيح إدارة متكاملة للعمولات والمندوبين، مع
                                إمكانية تخصيص سياسات عمولات مرنة لكل مندوب وربطهم بالفروع وقوائم
                                الأسعار. كما يوفر تقارير شاملة لأداء المندوبين تشمل المبيعات
                                والمرتجعات، مما يساعد في تحقيق أهداف الشركة بفعالية.
                            </p>
                        </div>
                    </div>
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                سياسات العمولات: إمكانية إنشاء وتخصيص سياسات عمولات مرنة تناسب
                                احتياجات العمل.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                عمولة المبيعات: حساب عمولات المندوبين بناءً على المبيعات
                                المنفذة.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                عمولة التحصيل: حساب عمولات المندوبين بناءً على تحصيل المبالغ
                                المستحقة.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تقسيم العمولات لشرائح والنسب على كل شريحة: نظام تقسيم العمولات
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                عدد لا نهائي من سياسات العمولات: إنشاء عدد لا محدود من سياسات
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                بيانات المندوبين: عرض جميع البيانات المتعلقة بالمندوبين مثل
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تحديد سياسة لكل مندوب: إمكانية تخصيص سياسة عمولات محددة لكل
                                مندوب بناءً على أدائه.
                            </p>
                        </div>
                        <div className="img md:w-1/2 flex justify-center ">
                            <img className="w-4/5  " src={invoices} alt="" />
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تحديد الفروع للمندوبين: ربط المندوبين بفروع محددة وفقًا لموقعهم
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                التارجت أو المستهدف لكل مندوب: تحديد أهداف واضحة لكل مندوب
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                فترة استحقاق العمولات: تحديد فترة استحقاق العمولات بناءً على
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                يوزر خاص للمندوبين وربطه بالفواتير: إنشاء حسابات خاصة للمندوبين
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تقارير المندوبين: إعداد تقارير شاملة مثل تقرير فواتير المبيعات،
                                تقرير مرتجعات المبيعات، صافي مبيعات ومرتجعات المندوبين، مبيعات
                                المندوبين من الأصناف، تجميعى وتفصيلى، ومرتجعات مبيعات المندوبين.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تتضمن تقارير الموردين العناصر التالية:
                                <br />
                                - تقرير فواتير الموردين.
                                <br />
                                -تقرير مرتجعات الموردين.
                                <br />
                                - صافي المشتريات والمرتجعات (بشكل تفصيلي ومجمع).
                                <br />
                                - يومية مرتجعات الأصناف (بشكل تجميعي وتفصيلي).
                                <br />
                                - أعمار الديون لفواتير المشتريات.
                                <br />
                                - كشف حساب المورد.
                                <br />
                                - كشف حساب المورد بالعملة.
                                <br />
                                - أرصدة الموردين.
                                <br />
                            </p>
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إدخال فاتورة المورد داخل الفاتورة بما يؤثر على تقرير الفحص
                                الضريبي.
                            </p>
                        </div>
                        <div className="img md:w-1/2 flex justify-center ">
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                حساب تكاليف الشراء وإعادة احتساب القيمة الحقيقية للمنتج.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إمكانية إنشاء طلبات شراء.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                    <i className="text-blue-600 me-2 fa-solid fa-circle-notch"></i>
                                </span>
                                إمكانية إنشاء طلبات البضاعة.
                            </p>
                        </div>
                    </div>
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                فواتير المشتريات الناتجة عن إذن إضافة مخزني.
                            </p>
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                ضبط تكلفة المنتجات على فواتير المشتريات.
                            </p>
                        </div>
                        <div className="img md:w-1/2 flex justify-center ">
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                التقارير الإدارية تشمل: إجمالي مبيعات الفروع، صافي المشتريات
                                الشهرية للفروع، وصافي المشتريات الشهرية للموردين.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                    <i className="text-blue-600 me-2 fa-solid fa-circle-notch"></i>
                                </span>
                                تقارير المشتريات تتضمن:
                                <br />
                                - تقارير المشتريات والمرتجعات
                                <br />
                                - تقرير مشتريات الفواتير
                                <br />
                                - تقرير مرتجعات الفواتير
                                <br />
                                - يومية المشتريات ومرتجعات الأصناف بشكل تفصيلي وتجميعي
                                <br />
                                - يومية المشتريات الأصناف تجميعي وتفصيلي
                                <br />
                                - مشتريات الفروع بشكل تجميعي وتفصيلي
                                <br />
                                - مرتجعات مشتريات الأصناف تجميعي وتفصيلي
                                <br />
                                - صرف فواتير المشتريات
                                <br />
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إذن صرف من فاتورة: يتم إصدار إذن صرف من فاتورة لإخراج المنتجات
                                بناءً على الفواتير المعتمدة، مع التأكد من مطابقة الكميات
                                والفواتير قبل إجراء عملية الصرف من المخزن.
                            </p>
                        </div>
                        <div className="img md:w-1/2 flex justify-center ">
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إذن إضافة من أمر توريد: يتم إصدار إذن إضافة من أمر توريد عند
                                استلام شحنة من المورد، مما يسمح بإدخال الكميات المستلمة إلى
                                المخزن وتحديث بيانات المخزون بشكل دقيق وفقًا لأمر التوريد
                                الأصلي.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إذن صرف من فاتورة مردودات المشتريات: يُستخدم إذن الصرف من فاتورة
                                مردودات المشتريات لإخراج البضائع المرتجعة من المخزن بناءً على
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إذن إضافة من فاتورة مردودات المبيعات: يتم إصدار إذن إضافة من
                                فاتورة مردودات المبيعات عند استلام المنتجات المرتجعة من العملاء،
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                استيراد الأصناف وأرصدة المخازن من ملفات Excel: يمكن استيراد
                                بيانات الأصناف وأرصدة المخازن بسهولة من ملفات Excel، مما يتيح
                                تحديث معلومات المخزون بشكل سريع ودقيق، ويوفر الوقت والجهد في
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تقييم المخزون بأي سياسة أسعار: يتم تقييم المخزون باستخدام أي
                                سياسة أسعار مناسبة، مثل التكلفة التاريخية أو متوسط التكلفة أو أي
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                تسمية الأصناف تلقائيًا أو يدويًا.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                    <i className="text-blue-600 me-2 fa-solid fa-circle-notch"></i>
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إمكانية ربط العملاء على مستوى الشركة ككل وتخصيص عملاء معينين
                                لفرع معين.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                ...
                                إنشاء قوائم أسعار خاصة لكل فرع وسياسات الأسعار لتحديد سعر البيع
                                لكل صنف.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                ...
                                متابعة أسعار المنافسين والمقارنة بينهم لاتخاذ قرارات البيع
                                والمنافسة.
                            </p>
                        </div>
                    </div>
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إعادة احتساب تكلفة المنتج وقت الاستيراد بما يشمل مصروفات الشحن
                                والنقل والجمارك.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                ...
                                إعدادات الباركود وتصميمه حسب رغبتك.
                            </p>
                        </div>
                        <div className="img md:w-1/2 flex justify-center ">
                    ...
                    <div className="fivth my-12 px-9 w-full md:flex">
                        ...
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                طباعة الباركود من أماكن متعددة.
                            </p>
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                إدارة المخزون في المخازن بدقة واحترافية، ومتابعة الأصناف الناقصة
                                لتعويضها في المخازن.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                ...
                                إدارة تواريخ الصلاحية بشكل كامل، مع إعطاء تحذير عن الكميات التي
                                أوشكت على انتهاء صلاحيتها.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                    <i className="text-blue-600 me-2 fa-solid fa-circle-notch"></i>
                    ...
                    <div className="third my-12 px-9 w-full md:flex">
                        <div className="data md:w-1/2 flex flex-col justify-center ">
                            ...
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                ...
                                متابعة حركة مندوبي البيع وحساب عمولاتهم بدقة حسب سياسة الشركة.
                            </p>
                            <p className="cairo text-blue-950 m-0 mt-4 md:text-lg text-base font-[650]">
                                <span>
                                    <i className="text-blue-600 me-2 fa-solid fa-circle-notch"></i>
